    ...
    return (
        <main className="flex flex-col items-center justify-center min-h-screen p-4">
            <div className="rounded-box m-10 p-10 bg-white/50 text-zinc-800 shadow-xl">
                <h3 className="mb-6 text-2xl font-semibold font-dmserif ">
                    Hi there!
                </h3>
                ...
                <button className="btn btn-soft btn-secondary rounded mt-5">
                    <Link href="/about">Learn more</Link>
                </button>
            </div>

            <div className="rounded-box w-full max-w-screen-lg mx-auto px-4 py-10 bg-white/50 shadow-xl text-zinc-800 flex flex-col items-center">
                <h4 className="mb-6 text-2xl font-semibold font-dmserif text-center ">
                    Previous Work
                </h4>
            ...
            <div className="rounded-box m-10 p-10 bg-white/50 text-zinc-800 shadow-xl">
                <h4 className="mb-6 text-2xl font-semibold font-dmserif  ">
                    Have a question?
                </h4>
                <p>
