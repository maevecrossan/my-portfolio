    ...
    return (
        <>
            ...
            >
                ...
                <figure aria-labelledby="work-heading" role="group" className="w-full rounded-2xl bg-white/20 backdrop-blur-lg border border-white/30 ring-1 ring-white/20 p-4">
