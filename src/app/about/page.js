                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="text-sm text-rose-300 text-center space-y-2">
                                ...
                                <div className="flex flex-col items-center gap-1">
                                    <a href="mailto:maevecrossan@gmail.com" className="inline-flex items-center gap-2 font-medium hover:underline">
                                ...
                                {/* Course blurb */}
                                <p className="max-w-xs mt-2 mx-auto mt-4">
                                ...
                                <p>
                                    <a href="/cv.pdf" className="font-semibold hover:underline mt-4" target="_blank" rel="noopener noreferrer">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="border-t border-rose-200 pt-4 max-w-4xl">
                                    ...
                                    <div className="space-y-2 text-gray-500">
                                        <p><strong>Languages &amp; Tools:</strong> HTML5, CSS3, JavaScript (ES5 &amp; ES6+), Python, Node.js, Next.js</p>
                                        <p><strong>Frameworks &amp; Libraries:</strong> React, React Router, Bootstrap, React-Bootstrap, Django, Django Allauth, Django Crispy Forms, Django Extensions, Flask, Axios (AJAX/data fetching), Tailwind CSS, jQuery</p>
                                        <p><strong>Styling &amp; Design:</strong> Responsive and Accessible Web Design, Mobile-first Principles</p>
                                        <p><strong>State &amp; Data Handling:</strong> RESTful APIs, JWT Authentication, OAuth2, Form Validation</p>
                                        <p><strong>Testing, Linting &amp; Developer Tools:</strong> React Testing Library, Jest, Pylint, Django Extensions, Chrome DevTools</p>
                                        <p><strong>Version Control &amp; Deployment:</strong> Git, GitHub, Gunicorn, Whitenoise (for Django deployment)</p>
                                        <p><strong>Databases:</strong> PostgreSQL, SQLite (development), MongoDB, MySQL</p>
                                        <p><strong>Other:</strong> Web Accessibility Principles (ARIA, semantic HTML), Agile Development, Microsoft Office Suite, AI Integration, Search Engine Optimization (SEO), Adobe Lightroom</p>
                                    </div>
                                </div>
                                        ...
                                        <li>
                                            ...
                                            <div>
                                                <FontAwesomeIcon icon={faGithub} className="mr-1"/>
                                                 <a className="hover:underline" target="_blank" rel="noopener noreferrer" href="https://github.com/maevecrossan/nomad-narratives">github.com/maevecrossan/nomad-narratives</a>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div>
                                                <FontAwesomeIcon icon={faGithub} className="mr-1"/>
                                                 <a className="hover:underline" target="_blank" rel="noopener noreferrer" href="https://github.com/maevecrossan/la-luna">github.com/maevecrossan/la-luna</a>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div>
                                                <FontAwesomeIcon icon={faGithub} className="mr-1"/>
                                                 <a className="hover:underline" target="_blank" rel="noopener noreferrer" href="https://github.com/maevecrossan/echoes-of-the-abyss">github.com/maevecrossan/echoes-of-the-abyss</a>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div>
                                                <FontAwesomeIcon icon={faGithub} className="mr-1"/>
                                                 <a className="hover:underline" target="_blank" rel="noopener noreferrer" href="https://github.com/maevecrossan/byte-battles">github.com/maevecrossan/byte-battles</a>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div>
                                                <FontAwesomeIcon icon={faGithub} className="mr-1"/>
                                                 <a className="hover:underline" target="_blank" rel="noopener noreferrer" href="https://github.com/maevecrossan/peaceful-path">github.com/maevecrossan/peaceful-path</a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
